...
B2. Write 800–1500 words in the brand voice ({{VOICE}}): 40–60-word answer capsule in the first 100 words; question-form H2s; each fan-out subquery answered under its own heading, first sentence = the direct answer, 40–80-word self-contained passage (AI engines quote passages, not pages); ≥5 cited statistics with named/linked sources (own labeled data counts; NEVER invent one); FAQ block + FAQPage JSON-LD in the body; 3–5 product cards (image + name + shop button, no prices); one real review quote if a review source exists; internal links to ≥1 collection + 2–3 older posts; UTM `utm_source=blog&utm_medium=organic&utm_content={handle}` on every store link; meta title ≤60 + meta description ≤155; alt text everywhere; CTA block ending in "{{TAGLINE_CTA}}". No health claims, no hardcoded prices/shipping.
