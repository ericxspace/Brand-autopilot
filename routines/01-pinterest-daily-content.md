...
- MIX: {{PRODUCT_PINS_PER_DAY}} fresh Product Pins + {{INSPIRATION_PINS_PER_DAY}} fresh Inspiration Pins + 0 repins (default 6+4; keep the total ≤10/day — fresh pins drive 90%+ of Pinterest traffic; repeated content is the #1 distribution-collapse risk). State the mix in every run summary.
